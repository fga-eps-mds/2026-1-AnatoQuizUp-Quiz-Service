...
import type { CriarQuestaoDto, FiltroListarQuestoesQueryDto, RegistroQuestaoCompleta } from "./dto/questao.types";
import type {
  AlternativasMultiplaEscolhaDto,
  AlternativasVerdadeiroFalsoDto,
} from "./dto/questao.types";
import { mapearTipoApiParaBanco } from "./dto/questao.types";
