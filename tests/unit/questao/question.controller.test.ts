...
import { QuestaoController } from "../../../src/modules/questao/questao.controller";
import type { QuestaoService } from "../../../src/modules/questao/questao.service";
import type {
  CriarQuestaoDto,
  RespostaQuestaoDto,
} from "../../../src/modules/questao/dto/questao.types";
...
describe("QuestaoController", () => {
  ...
  let questionService: jest.Mocked<QuestaoService>;
  ...
  beforeEach(() => {
    questionService = {
      ...
      remover: jest.fn(),
      filtrar: jest.fn(),
    } as unknown as jest.Mocked<QuestaoService>;
    controller = new QuestaoController(questionService);
    jest.clearAllMocks();
  });
